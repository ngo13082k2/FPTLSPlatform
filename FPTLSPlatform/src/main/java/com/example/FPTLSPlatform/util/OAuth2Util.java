...
public class OAuth2Util {
    ...
    private static final String CREDENTIALS_FILE_PATH = "/credentials.json"; // Đường dẫn tới file credentials.json trong resources
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        File credentialsPath = Paths.get("src/main/resources/credentials.json").toFile();
